...
En plus du stockage local, vous pouvez avoir besoin de davantage de stockage externe pour effectuer des sauvegardes. Dans ce cas, vous pouvez commander un stockage par blocs ou un stockage NAS (Network Attached Storage) comme décrit dans [Stockage](/docs/infrastructure/sap-hana?topic=sap-hana-iaas-overview#storage). Etant donné que les données du stockage par blocs ou du système de fichiers réseau (NFS) supplémentaires sont transférées par le biais des mêmes adaptateurs physiques que le reste du trafic réseau, prenez en compte l'impact généré.
...
Pour plus d'informations sur la haute disponibilité et la reprise après incident, voir [Prise en charge de la haute disponibilité {{site.data.keyword.cloud_notm}}](/docs/infrastructure/sap-hana?topic=sap-hana-ha#ha) et [Reprise après incident](/docs/infrastructure/sap-reference-architecture?topic=sap-reference-architecture-recommendations#dr).

Pour plus d'informations sur la réplication du système, le débit du réseau et le temps d'attente, voir
  * [How To Perform System Replication for SAP HANA ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://www.sap.com/documents/2013/10/26c02b58-5a7c-0010-82c7-eda71af511fa.html){: new_window}
  * [Network Required for SAP HANA System Replication ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://www.sap.com/documents/2014/06/babb2b55-5a7c-0010-82c7-eda71af511fa.html){: new_window}
...
Pour plus d'informations sur la configuration des extensions de cluster à haute disponibilité pour votre système d'exploitation Linux, voir
  * [Automated SAP HANA System Replication with Pacemaker on RHEL Setup Guide ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://access.redhat.com/articles/1466063){: new_window}
  * [SAP HANA SR Performance Optimized Scenario ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://www.suse.com/docrep/documents/ir8w88iwu7/suse_linux_enterprise_server_for_sap_applications_12_sp1.pdf){: new_window}
...
Pour plus d'informations, voir la documentation suivante :
  * [Note SAP 2414820 ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://launchpad.support.sap.com/#/notes/2414820){: new_window}
  ...
  * [Note SAP Note 1943937 ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://launchpad.support.sap.com/#/notes/1943937){: new_window}
  * [SAP HANA Tailored Data Center Integration Frequently Asked Questions ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://www.sap.com/documents/2016/05/e8705aae-717c-0010-82c7-eda71af511fa.html){: new_window}
  * [Note SAP 1995460 ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://launchpad.support.sap.com/#/notes/1995460){: new_window}
  * [Note SAP 2024433 ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://launchpad.support.sap.com/#/notes/2024433){: new_window}
  * [SAP HANA Tailored Data Center Intgration (TDI) Overview ![Icône de lien externe](../../icons/launch-glyph.svg "Icône de lien externe")](https://blogs.saphana.com/2015/02/18/sap-hana-tailored-data-center-integration-tdi-overview/){: new_window}
