...
Para obtener más información, consulte [Iniciación a {{site.data.keyword.blockstorageshort}}](/docs/infrastructure/BlockStorage?topic=BlockStorage-getting-started#getting-started) e [Iniciación a {{site.data.keyword.filestorage_full_notm}}](/docs/infrastructure/FileStorage?topic=FileStorage-getting-started#getting-started).
...
Para obtener más información sobre la alta disponibilidad y la recuperación tras desastre, consulte [Soporte de alta disponibilidad de {{site.data.keyword.cloud_notm}}](/docs/infrastructure/sap-hana?topic=sap-hana-ha#ha) y
[Recuperación tras desastre](/docs/infrastructure/sap-reference-architecture?topic=sap-reference-architecture-recommendations#dr).

Para obtener más información sobre la réplica del sistema y el rendimiento y la latencia de red, consulte
  * [Cómo realizar una réplica del sistema para SAP HANA ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://www.sap.com/documents/2013/10/26c02b58-5a7c-0010-82c7-eda71af511fa.html){: new_window}
  * [Red necesaria para la réplica del sistema de SAP HANA ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://www.sap.com/documents/2014/06/babb2b55-5a7c-0010-82c7-eda71af511fa.html){: new_window}
...
Para obtener más información sobre cómo configurar las extensiones de clúster HA para el sistema operativo Linux, consulte
  * [Réplica automatizada del sistema SAP HANA con Pacemaker en la Guía de configuración de RHEL ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://access.redhat.com/articles/1466063){: new_window}
  * [Escenario optimizado de rendimiento de SAP HANA SR ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://www.suse.com/docrep/documents/ir8w88iwu7/suse_linux_enterprise_server_for_sap_applications_12_sp1.pdf){: new_window}
...
El proceso de dimensionamiento para un despliegue basado en ESX difiere del de un despliegue de servidor nativo. Siga las recomendaciones del manual *Directrices de arquitectura y métodos recomendados para despliegues de SAP HANA en VMware vSphere: Guía de consideraciones técnicas y arquitectura*. Hay que calcular la sobrecarga de los requisitos de la capa de virtualización siguiendo las reglas del manual *Architecture...and Considerations Guide*. Después de desplegar el sistema operativo invitado en una máquina virtual, asegúrese de que se cumplan los KPI de TDI de SAP HANA. Consulte la Nota de SAP 1943937 para ver detalles sobre cómo comprobar que el entorno cumple con los requisitos previos del soporte de SAP. Se deben cumplir los requisitos previos en cada máquina virtual desplegada en un servidor específico.
...
Para obtener más información, consulte la documentación siguiente:
  * [Nota de SAP 2414820 ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://launchpad.support.sap.com/#/notes/2414820){: new_window}
  ...
  * [Nota de SAP 1943937 ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://launchpad.support.sap.com/#/notes/1943937){: new_window}
  * [Preguntas más frecuentes sobre la integración de un centro de datos adaptado de SAP HANA ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://www.sap.com/documents/2016/05/e8705aae-717c-0010-82c7-eda71af511fa.html){: new_window}
  * [Nota de SAP 1995460 ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://launchpad.support.sap.com/#/notes/1995460){: new_window}
  * [Nota de SAP 2024433 ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://launchpad.support.sap.com/#/notes/2024433){: new_window}
  * [Visión general sobre la integración de un centro de datos adaptado (TDI) de SAP HANA ![Icono de enlace externo](../../icons/launch-glyph.svg "Icono de enlace externo")](https://blogs.saphana.com/2015/02/18/sap-hana-tailored-data-center-integration-tdi-overview/){: new_window}
